...
namespace SnapMaster
{
    public class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            using (var ms = new MemoryStream(Snippy.Properties.Resources.snapmaster))
            {
        ...
        void BuildHeader()
        {
            ...
            using (var ms = new MemoryStream(Snippy.Properties.Resources.snapmaster_icon_24x24))
            {
        ...
        void SaveAndNotify(Bitmap bmp, string tag)
        {
            ...
            try
            {
                ...
                trayIcon?.ShowBalloonTip(2000, "Snippy", $"Saved {name}.{ext}", ToolTipIcon.None);
            }
            finally
            {
                imageToSave?.Dispose();
        ...
        void CompleteStopRecording(string savedPath, Exception error, DateTime ts)
        {
            ...
            trayIcon?.ShowBalloonTip(1500, "Snippy", $"Saved {Path.GetFileName(savedPath)}", ToolTipIcon.None);
        }
        ...
        void SetupTray()
        {
            ...
            {
                Text = "Snippy - Ctrl+Alt+S to show",
                Icon = appIcon,
                Visible = true
            };

            var menu = new ContextMenuStrip();
            menu.Items.Add("Open Snippy (Ctrl+Alt+S)", null, (s, e) => ShowFromTray());
        ...
        void ShowFromTray()
        {
            ...
            ShowStatus(showAppHotkeyRegistered
                ? "● Ready — Ctrl+Alt+S shows Snippy from the tray"
        ...
        // void CloseScreenOverlays(List<ScreenNumberOverlay> overlays)
        //{
        ...
        //Bitmap CaptureRectangle(Rectangle region)
        //{
        ...
        //        if (includeMouseCursor)
        //            DrawCursor(g, region.Location);
        //    }

        //    return bmp;
        //}

        //Bitmap StitchVertical(List<Bitmap> images)
        //{
